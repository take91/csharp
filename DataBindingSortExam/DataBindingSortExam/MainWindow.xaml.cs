...
namespace DataBindingSortExam
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void DCChange(object sender, DependencyPropertyChangedEventArgs e)
        {
            MyCollectionView = CollectionViewSource.GetDefaultView(rootElement.DataContext) as ListCollectionView;
        ...
        private void OnClick(object sender, RoutedEventArgs e)
        {
            ...
            switch (b.Name)
            {
                case "BtnEmpno":MyCollectionView.SortDescriptions.Add(new SortDescription("Empno", ListSortDirection.Ascending));
                    break;
                case "BtnEname":
                    MyCollectionView.SortDescriptions.Add(new SortDescription("Ename", ListSortDirection.Ascending));
                    break;
                case "BtnJob":
                    MyCollectionView.SortDescriptions.Add(new SortDescription("JobSSSS", ListSortDirection.Ascending));
                    break;
